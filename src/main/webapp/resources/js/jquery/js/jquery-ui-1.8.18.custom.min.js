...
(function(a,b){
    ...
    a.widget=function(b,c,d){
        ...
        _trigger:function(b,c,d){
            ...
            if(f)for(e in f)e in c||(c[e]=f[e]);this.element.trigger(c,d);
...
(function(a,b){
    a.widget("ui.sortable",a.ui.mouse,{
        ...
        _contactContainers:function(b){
            ...
            if(!!c)if(this.containers.length===1)this.containers[d]._trigger("over",b,this._uiHash(this)),this.containers[d].containerCache.over=1;
